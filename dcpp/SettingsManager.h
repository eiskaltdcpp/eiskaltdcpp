...
public:
    ...
    enum StrSetting { STR_FIRST,
        ...
        LANGUAGE, DOWNLOADS_ORDER, DOWNLOADS_WIDTHS, SKIPLIST_SHARE,
    ...
    enum IntSetting { INT_FIRST = STR_LAST + 1,
        ...
        AUTO_SEARCH, AUTO_SEARCH_TIME, REPORT_ALTERNATES, TIME_STAMPS, POPUP_HUB_PMS, POPUP_BOT_PMS, IGNORE_HUB_PMS, IGNORE_BOT_PMS,
        ...
        GET_USER_COUNTRY, FAV_SHOW_JOINS, LOG_STATUS_MESSAGES, SHOW_STATUSBAR, ALLOW_UPDATE_FILELIST_ON_STARTUP,
        SHOW_TOOLBAR, SHOW_TRANSFERVIEW, POPUNDER_PM, POPUNDER_FILELIST, MAGNET_ASK, MAGNET_ACTION, MAGNET_REGISTER, SEARCH_PASSIVE,
        ...
        NO_IP_OVERRIDE, NO_USE_TEMP_DIR, SHARE_TEMP_FILES, SEARCH_ONLY_FREE_SLOTS, LAST_SEARCH_TYPE, BOLD_FINISHED_DOWNLOADS, BOLD_FINISHED_UPLOADS, BOLD_QUEUE,
        BOLD_HUB, BOLD_PM, BOLD_SEARCH, BOLD_SEARCH_SPY,
        THROTTLE_ENABLE, MAX_UPLOAD_SPEED_LIMIT, MAX_DOWNLOAD_SPEED_LIMIT, MAX_UPLOAD_SPEED_LIMIT_NORMAL,
        MAX_DOWNLOAD_SPEED_LIMIT_NORMAL, MAX_UPLOAD_SPEED_LIMIT_TIME, MAX_DOWNLOAD_SPEED_LIMIT_TIME,
        TIME_DEPENDENT_THROTTLE, BANDWIDTH_LIMIT_START, BANDWIDTH_LIMIT_END, SOCKET_IN_BUFFER, SOCKET_OUT_BUFFER,
        ...
        SEARCH_MERGE, HASH_BUFFER_SIZE_MB, HASH_BUFFER_POPULATE, HASH_BUFFER_NORESERVE, HASH_BUFFER_PRIVATE, USE_DHT, DHT_PORT, RECONNECT_DELAY, AUTO_DETECT_CONNECTION,
        INT_LAST };
