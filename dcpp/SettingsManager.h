...
public:
    ...
    enum StrSetting { STR_FIRST,
        ...
        EMAIL, EXTERNAL_IP, TEXT_FONT, HUBLIST_SERVERS,
        ...
        LANGUAGE, SKIPLIST_SHARE,
        SOUND_MAIN_CHAT, SOUND_PM, SOUND_PM_WINDOW, INTERNETIP,
        STR_LAST };

    enum IntSetting { INT_FIRST = STR_LAST + 1,
        INCOMING_CONNECTIONS = INT_FIRST, TCP_PORT, SLOTS,
        AUTO_FOLLOW, CLEAR_SEARCH, BACKGROUND_COLOR, TEXT_COLOR,
        USE_OEM_MONOFONT, SHARE_HIDDEN, FILTER_MESSAGES,
        MINIMIZE_TRAY, ALWAYS_TRAY, AUTO_SEARCH, AUTO_SEARCH_TIME,
        REPORT_ALTERNATES, TIME_STAMPS, POPUP_HUB_PMS, POPUP_BOT_PMS,
        ...
        SHOW_JOINS, USE_SYSTEM_ICONS, POPUP_PMS, MIN_UPLOAD_SPEED,
        GET_USER_INFO, URL_HANDLER, AUTO_AWAY, SOCKS_PORT, SOCKS_RESOLVE,
        KEEP_LISTS, AUTO_KICK, QUEUEFRAME_SHOW_TREE, COMPRESS_TRANSFERS,
        SFV_CHECK, MAX_COMPRESSION, NO_AWAYMSG_TO_BOTS, SKIP_ZERO_BYTE,
        ADLS_BREAK_ON_FIRST, HUB_USER_COMMANDS, AUTO_SEARCH_AUTO_MATCH,
        UPLOAD_BAR_COLOR, DOWNLOAD_BAR_COLOR, LOG_SYSTEM,
        LOG_FILELIST_TRANSFERS, SEND_UNKNOWN_COMMANDS, MAX_HASH_SPEED,
        OPEN_USER_CMD_HELP, GET_USER_COUNTRY, FAV_SHOW_JOINS,
        LOG_STATUS_MESSAGES, SHOW_STATUSBAR, ALLOW_UPDATE_FILELIST_ON_STARTUP,
        ...
        SHOW_LAST_LINES_LOG, ADC_DEBUG, TOGGLE_ACTIVE_WINDOW,
        ...
        LAST_SEARCH_TYPE, BOLD_FINISHED_DOWNLOADS, BOLD_FINISHED_UPLOADS,
        BOLD_QUEUE, BOLD_HUB, BOLD_PM, BOLD_SEARCH, BOLD_SEARCH_SPY,
        SOCKET_IN_BUFFER, SOCKET_OUT_BUFFER,
        OPEN_WAITING_USERS, BOLD_WAITING_USERS, OPEN_SYSTEM_LOG,
        BOLD_SYSTEM_LOG, AUTO_REFRESH_TIME, USE_TLS, AUTO_SEARCH_LIMIT,
        ALT_SORT_ORDER, AUTO_KICK_NO_FAVS, PROMPT_PASSWORD,
        ...
        FOLLOW_LINKS, SEND_BLOOM, OWNER_DRAWN_MENUS, CORAL,
        SEARCH_FILTER_SHARED, MAX_TAB_CHARS, FINISHED_DL_ONLY_FULL,
        CONFIRM_EXIT, CONFIRM_HUB_CLOSING, CONFIRM_HUB_REMOVAL,
        CONFIRM_USER_REMOVAL, CONFIRM_ITEM_REMOVAL, CONFIRM_ADLS_REMOVAL,
