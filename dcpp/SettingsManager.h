...
public:
    ...
    enum StrSetting { STR_FIRST,
        ...
        BIND_ADDRESS, BIND_ADDRESS6, SOCKS_SERVER, SOCKS_USER, SOCKS_PASSWORD,
        ...
        DHT_KEY, DYNDNS_SERVER, MIME_HANDLER, BIND_IFACE_NAME6,
        STR_LAST };
    ...
    enum IntSetting { INT_FIRST = STR_LAST + 1,
        ...
        NMDC_DEBUG, SHARE_SKIP_ZERO_BYTE, REQUIRE_TLS, LOG_SPY, BIND_IFACE6,
        INT_LAST };
