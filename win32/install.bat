...
echo [Paths] > "%INSTALLDIR%\qt.conf"
echo Plugins = ./plugins >> "%INSTALLDIR%\qt.conf"
...
copy /Y "%MINGW%\bin\libiconv-2.dll"              "%INSTALLDIR%"
copy /Y "%MINGW%\bin\libz-1.dll"                  "%INSTALLDIR%"
copy /Y "%MINGW%\bin\libbz2-2.dll"                "%INSTALLDIR%"
...
mkdir "%INSTALLDIR%\aspell\data\"
mkdir "%INSTALLDIR%\aspell\dict\"
copy /Y "%MINGW%\lib\aspell-0.60\*"               "%INSTALLDIR%\aspell\data\"

copy /Y "%SystemRoot%\System32\ssleay32.dll"      "%INSTALLDIR%"
copy /Y "%SystemRoot%\System32\libeay32.dll"      "%INSTALLDIR%"

mkdir "%INSTALLDIR%\plugins\sqldrivers\"
copy /Y "%QTDIR%\plugins\sqldrivers\qsqlite4.dll" "%INSTALLDIR%\plugins\sqldrivers\"
