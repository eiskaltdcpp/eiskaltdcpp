...
bool WulforUtil::loadIcons(){
    ...
    m_PixmapMap[eiCLIENT] = loadPixmap("client.png");
    m_PixmapMap[eiCOLORS] = loadPixmap("colors.png");
    ...
    m_PixmapMap[eiDEBUG] = loadPixmap("debug.png");
    ...
    m_PixmapMap[eiGO_NEXT] = loadPixmap("go-next.png");
    m_PixmapMap[eiGO_PREVIOUS] = loadPixmap("go-previous.png");
    m_PixmapMap[eiGO_UP] = loadPixmap("go-up.png");
    ...
    m_PixmapMap[eiICON_MSG] = loadPixmap("icon_msg.png");
    m_PixmapMap[eiICONS] = loadPixmap("icons.png");
    m_PixmapMap[eiINFO] = loadPixmap("info.png");
    m_PixmapMap[eiISAWAY] = loadPixmap("isaway.png");
    m_PixmapMap[eiLOG] = loadPixmap("log.png");
    m_PixmapMap[eiMENU] = loadPixmap("menu.png");
    ...
    m_PixmapMap[eiONLINEMANUAL] = loadPixmap("onlinemanual.png");
    m_PixmapMap[eiOPEN] = loadPixmap("open.png");
    m_PixmapMap[eiOTHER] = loadPixmap("other.png");
    m_PixmapMap[eiQUICKOPTIONS] = loadPixmap("quickoptions.png");
    ...
    m_PixmapMap[eiSLOTS_UP] = loadPixmap("slots_up.png");
    ...
    m_PixmapMap[eiSUPPORT] = loadPixmap("support.png");
    ...
    m_PixmapMap[eiVRU] = loadPixmap("vru.png");
    m_PixmapMap[eiZOOM_IN] = loadPixmap("zoom-in.png");
    m_PixmapMap[eiZOOM_OUT] = loadPixmap("zoom-out.png");

    m_PixmapMap[eiFLAG_BELARUS] = loadPixmap("flag_belarus.png");
